...
import OpenLinkSVG from "../components/icons/open-link.svg";
...
const StyledWrapper = styled.div`
  ...
  margin: 3em 5em;
  ${media.tablet`margin: 1.5em;`}
  ${media.thone`margin: 0.5em;`}
`;
    ...
    <Layout>
      <StyledContainer>
        <StyledWrapper>
          ...
          <StyledAppsDiv>
            {appList.map((app, appKey) => (
              <StyledAppCard key={appKey}>
                ...
                <StyledDetails>
                  <h2>
                    ...
                    <div>
                      {app.homepage && (
                        <a target="_blank" href={app.homepage}>
                          <OpenLinkSVG />
                        </a>
                      )}
                      {app.githubUrl && (
                        <a target="_blank" href={app.githubUrl}>
                          <GithubSVG />
                        </a>
                      )}
                    </div>
